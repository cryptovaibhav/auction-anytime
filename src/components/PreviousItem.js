                ...
                ?   <div className="col-md-4 align-self-center">
                        <div className="card mb-4 box-shadow opaque">
                            ...
                            <div className="card-body">
                                <h1>Winner: </h1>
                                <h3 className="card-title pricing-card-title" title={props.item.highestBidder}>{props.item.highestBidder}</h3>
                                <h1>Winning Bid: </h1>
                                <h3 className="card-title pricing-card-title">{props.item.highestBid} <small className="text-muted"> NEAR </small></h3>
                                <ul className="list-unstyled mt-3 mb-4">
                                    <li title={props.item.owner}><b>Listed By: </b>{ props.item.owner }
                                    </li>
                                </ul>
                            </div>
                        </div>  
